...
export default function CaptchaResetPassScreen() {
  ...
  useEffect(() => {
    if (isVerified) {
      // Quay lại màn hình FindPhoneNum và truyền trạng thái xác thực
      router.replace({
        pathname: "/(auth)/resetPass/findPhoneNum",
        params: {
          phoneNumber,
          verified: "true", // Chuyển trạng thái thành chuỗi
        },
      });
    }
  }, [isVerified]);
