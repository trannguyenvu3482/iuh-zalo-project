 ...
 */
export const navigateToCall = ({ calleeId, callerId, callerName, callType = 'video', channelName }) => {
  if (!channelName) {
  ...
  console.log('Navigating to call page with URL:', callUrl, 'Channel name:', channelName);
